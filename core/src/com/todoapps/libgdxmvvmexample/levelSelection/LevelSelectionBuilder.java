...
public class LevelSelectionBuilder extends Builder<LevelSelectionRouter> {
    ...
    @Override
    public LevelSelectionRouter build(Dependency dependency, Game game) {
        ...
        LevelSelectionRouter levelSelectionRouter = new LevelSelectionRouter(levelSelectionScreen, homeViewModel, dependency, game);
